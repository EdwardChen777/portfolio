...
import profile from "../imgs/profile3.png";
          ...
          <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 `}>
                <div className='flex flex-row justify-between items-center w-full'>
                    <h2 className={`flex-1 font-montserrat font-semibold ss:text-[44px] text-[32px] text-white ss:leading-[80px] leading-[75px]`}>
                        Hi, I am Edward!
            ...
            <div className={`flex-1 ${styles.flexEnd} flex-col xl:px-0 sm:px-16 px-6 mt-[15px] sm:mt-0 `} >
                <img src={profile} alt="profile" className='w-[300px] sm:w-[350px] m-auto'/>
            </div>
